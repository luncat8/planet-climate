...
var PARAMS = {
  ...
  thermo:    { label: 'Diapycnal mixing',     default: 2e-7,  min: 0,   max: 2e-6, step: 2e-8, fmt: function (v) { return v.toExponential(1); } },
  oceanConv: { label: 'Convective exchange',  default: 8e-8,  min: 0,   max: 2e-6, step: 1e-8, fmt: function (v) { return v.toExponential(1); } },
  oceanDrag: { label: 'Layer drag',           default: 4e-7,  min: 0,   max: 4e-6, step: 1e-7, fmt: function (v) { return v.toExponential(1); } },
  etaDamp:   { label: 'Free-surf damp',       default: 1e-6,  min: 0,   max: 5e-5, step: 1e-7, fmt: function (v) { return v.toExponential(1); } },
  gInt:      { label: 'Internal gravity',      default: 120,  min: 0,   max: 600,  step: 10,   fmt: function (v) { return v.toFixed(0); } },
